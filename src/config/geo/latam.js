export const LATAM = {
  ...
  ndb:      { type: 'combined', amt: 5, ndCur: 'USD', wager: 45, maxW_x: 5, fs: 15, days: 7, limit: 'v_1_per_account', trigger: 'v_reg_verify' },
  reload:   { maxBMulti: 2.5, maxBMin: 0, maxBMax: 75, day: 'v_day_wed', fs: 20, cur: 'USD' },
  wager:    { model: 'standard', wW: 40, wN: 45, wR: 35, wF: 30, mb: 'v_no_limit', days: 30, basis: 'v_bonus_only', games: 'v_slots_only' },
  cashback: { model: 'flat', pct: 10, cur: 'USD', period: 'v_weekly', basis: 'v_net_losses', wager: 0, minLossRatio: 0.33, maxAmtRatio: 17 },
