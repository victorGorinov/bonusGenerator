export const CIS = {
  ...
  ndb: { type: 'combined', amt: 30, ndCur: 'FS', wager: 55, maxW_x: 5, fs: 50, days: 7 },
  ...
  cashback: { model: 'flat', pct: 10, period: 'v_weekly', basis: 'v_net_losses', wager: 0, minLossRatio: 0.30, maxAmtRatio: 50 },
