export const EU = {
  ...
  mix:  [0.60, 0.30, 0.05, 0.05],
  wcrs: [1.0, 0.0, 0.0, 0.5],

  welcome: {
    pct: 100, maxBMulti: 6, maxBMin: 1000, maxBMax: 5000,
    minDRatio: 0.15, minDMin: 10, fs: 200, days: 30, code: 'WELCOME100',
  },
  ndb: { type: 'combined', amt: 10, ndCur: 'FS', wager: 45, maxW_x: 3, fs: 50, days: 7 },
  ...
  cashback: {
    model: 'tier', period: 'v_monthly', basis: 'v_net_losses_monthly', wager: 0,
    tiers: [
      { name: 'ct_bronze',   color: '#CD7F32', fromX: 0,    toX: 100,  pct: '5%' },
      { name: 'ct_silver',   color: '#94A3B8', fromX: 100,  toX: 500,  pct: '10%' },
      { name: 'ct_gold',     color: '#D97706', fromX: 500,  toX: 2000, pct: '15%' },
      { name: 'ct_platinum', color: '#7C3AED', fromX: 2000, toX: null, pct: '20%' },
    ],
  },
  ...
  reg: ['reg_mga_1', 'reg_mga_2', 'reg_mga_3', 'reg_mga_4', 'reg_mga_5'],

  licenses: {
    ukgc: {
      welcome: { maxBMin: 100, maxBMax: 200 },
      ndb:     { type: 'fs_restricted', amt: 0, ndCur: 'FS', wager: 10, maxW_x: 3, fs: 20, days: 7, note: 'ukgc_note' },
      ...
      reg:     ['reg_ukgc_1', 'reg_ukgc_2', 'reg_ukgc_3', 'reg_ukgc_4', 'reg_ukgc_5', 'reg_ukgc_6'],
    },
  },
};
