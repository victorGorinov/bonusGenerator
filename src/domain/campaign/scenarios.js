...
export const LANG_NAME = { de:'German', en:'English', ru:'Russian', es:'Spanish', mn:'Mongolian' };
export const SEG_DESC  = { new:'new players (first-timers)', mid:'regular players', vip:'VIP high-value players' };

export const SCENARIO_MSG = {
