...
const LANG = {
  en: {
    ...
    fs1_p: '9 jurisdictions pre-configured — correct wager caps, currencies, and license rules out of the box.',
  ...
  ru: {
    ...
    tr1: 'Готово за 2 минуты', tr2: 'Без регистрации', tr3: 'Бесплатно в бете', tr4: '9 юрисдикций',
    ...
    fs1_p: '9 юрисдикций уже настроены — верные лимиты вейджера, валюты и правила лицензий из коробки.',
