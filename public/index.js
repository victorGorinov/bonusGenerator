...
const LANG = {
  en: {
    ...
    t_try: 'Try →',
    badge: 'Compliance-Ready Bonus Platform for iGaming',
    hero_h1a: 'Stop Configuring Bonuses in Spreadsheets.',
    hero_h1b: 'AI Does It — Compliant, Costed, Ready to Start.',
    hero_sub: 'Pick a scenario, set your geo — AI selects the right bonus mechanic, writes ready-to-send copy for 5 channels, models the cost, and flags compliance issues. Or design a full tournament: prize structure, economics, setup guide, AI texts. Everything in under 2 minutes.',
    ...
    lic_sub: 'Bonus caps, wager limits, mandatory regulatory strings, and self-exclusion checks — each license has its own rules. BonusEngine knows them and applies them automatically.',
    ...
    prev_ui: 'AI Campaign Generator — EU / MGA · €50 avg. deposit · 1000 players',
    ...
    ex_sub: 'This is exactly what BonusEngine generates: the right bonus mechanic, compliance-checked texts for 5 channels, and a full cost model — ready to hand to your dev team.',
  ...
  ru: {
    ...
    t_try: 'Открыть →',
    badge: 'Compliance-Ready платформа бонусов для iGaming',
    hero_h1a: 'Хватит настраивать бонусы в таблицах.',
    hero_h1b: 'AI сделает это — соответствие, экономика, готово к старту.',
    ...
    f4_h: 'Мульти-гео движок бонусов',
    ...
    lic_sub: 'Лимиты бонусов, лимиты вейджера, обязательные регуляторные строки и проверки на самоисключение — у каждой лицензии свои правила. BonusEngine знает их и применяет автоматически.',
    ...
    prev_ui: 'AI Campaign Generator — ЕС / MGA · €50 ср. депозит · 1000 игроков',
    ...
    ex_sub: 'Именно это генерирует BonusEngine: правильная механика бонуса, тексты для 5 каналов с проверкой комплаенса и полная модель стоимости — готово для передачи в разработку.',
