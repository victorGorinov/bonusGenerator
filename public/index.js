...
const LANG = {
  en: {
    ...
    hero_cta1: '📅 Build Retention Calendar →',
    ...
    sticky_cta: '📅 Build Retention Calendar →',
    ...
    demo_btn: '📅 Start Planning →',
    demo_btn2: '🤖 Campaign Generator',
  ...
  ru: {
    ...
    hero_cta1: '📅 Открыть Retention Calendar →',
    ...
    sticky_cta: '📅 Открыть Retention Calendar →',
    ...
    demo_btn: '📅 Начать планирование →',
    demo_btn2: '🤖 Генератор кампаний',
