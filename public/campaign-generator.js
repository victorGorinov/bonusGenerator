...
function generateAdminConfig() {
  ...
  return `${LINE}
 BONUS ENGINE — ADMIN PANEL CONFIG
...
const I18N = {
  ru: {
    ...
    s3_title:'Механика подобрана ✓', s3_sub:'Параметры рассчитаны по региональной модели BonusEngine для вашего сценария',
  ...
  en: {
    ...
    s3_title:'Mechanic Selected ✓', s3_sub:'Parameters calculated using the regional BonusEngine model for your scenario',
...
function updateTopbar(name) {
  const subMap = { configurator:'Bonus Engine v2.0', wizard:'AI Campaign Generator' };
